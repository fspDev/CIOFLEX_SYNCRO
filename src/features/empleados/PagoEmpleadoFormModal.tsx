...
import { crearPagoEmpleado } from '../../lib/repo'
...
export function PagoEmpleadoFormModal({ open, onClose, onSaved, empleadoId }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true)
    try {
      await crearPagoEmpleado({ empleadoId, monto, fecha, formaPago, nota: nota || undefined })
      onSaved()
      onClose()
      setMonto(0)
      setNota('')
